...
\startdescription{2008-2011}
  {\bf Classe préparatoire MPSI/MP*}; lycés Albert schweitzer, Le Raincy
  (93)
\stopdescription
...
\startdescription{2014-2017}
  {\bf Thèse en maths appliquées.} Les manières de représenter la santé
  et le vivant ont considérablement changé durant ces dernières années,
  et les nouvelles représentations font appel à la collecte de données
  massives. De telles représentations concernent plus particulièrement
  les données épidémiologiques et démographiques, ainsi que les données
  biologiques issues de plates-formes à haut débit. L'objectif de cette
  thèse est de développer les méthodes qui permetent de detecter les
  signatures d'association entre variables dans telless données. En
  particulier nous nous interessons aux modèles basées sur des problèmes
...
\startdescription{Février-Août 2014}
  ...
  méthodes de simulation 3D basées sur des exemples. Il fallait par la
  suite implémenter un prototype à l'aide d'openGL et C++.
\stopdescription

\startdescription{Juillet-Aout 2013}
  {\bf Stage ingénieur R&D à l'INRIA Montbonnot (38).} Dans l'équipe
...
\startitemize
\item
  \useURL[url1][http://membres-timc.imag.fr/Olivier.Francois/][][Olivier
  Francois]\from[url1], maître de conférence rattaché à l'ENSIMAG et au
  laboratoire TIMC-IMAG (La Tronche, France)
\item
  \useURL[url2][http://membres-timc.imag.fr/Michael.Blum/][][Michael
  Blum]\from[url2], directeur de recherche CNRS rattaché au laboratoire
  TIMC-IMAG et responsable de l'équipe BCM (La Tronche, France)
\item
  \useURL[url3][https://www.linkedin.com/in/everton-hermann-59908a6/][][Everton
  Hermann]\from[url3], ingenieur de recherche à Dassault Systemes
...
\startblockquote
\useURL[url4][mailto:kevin.caye@gmail.com][][kevin.caye@gmail.com]\from[url4]
