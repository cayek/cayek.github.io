...
\startdescription{Informatique}
  {\bf Programmation :} R, C/C++, python, SQL.

  {\bf OS :} Linux, OS X.

  {\bf Outils :} Emacs, Org mode, Git, RStudio, Jupyter, Méthodologie
  Agile.
\stopdescription
...
\useURL[url2][http://dx.doi.org/10.1111/mec.13513][][10.1111/mec.13513]\from[url2]
...
\useURL[url3][http://dx.doi.org/10.1111/1755-0998.12471][][10.1111/1755-0998.12471]\from[url3]
...
\startitemize
\item
  \useURL[url4][http://membres-timc.imag.fr/Olivier.Francois/][][Olivier
  Francois]\from[url4], maître de conférence rattaché à l'ENSIMAG et au
  laboratoire TIMC-IMAG (La Tronche, France)
\item
  \useURL[url5][http://membres-timc.imag.fr/Michael.Blum/][][Michael
  Blum]\from[url5], directeur de recherche CNRS rattaché au laboratoire
...
\startblockquote
\useURL[url6][mailto:kevin.caye@gmail.com][][kevin.caye@gmail.com]\from[url6]
• +33 6 19 45 11 46 • 26 ans\crlf
18 rue du pont prouiller - La Tronche 38700, France\crlf
\useURL[url7][https://cayek.github.io/]\from[url7]
\stopblockquote
