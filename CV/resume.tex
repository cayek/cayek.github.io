...
\startdescription{Informatique}
  {\bf Programmation :} R, python (scikit-learn, TensorFlow), C/C++,
  Cuda, Scala, SQL.
...
\startitemize
\item
  \useURL[url3][http://membres-timc.imag.fr/Olivier.Francois/][][Olivier
  Francois]\from[url3], maître de conférence rattaché à l'ENSIMAG et au
  laboratoire TIMC-IMAG (La Tronche, France)
\item
  \useURL[url4][http://membres-timc.imag.fr/Michael.Blum/][][Michael
  Blum]\from[url4], directeur de recherche CNRS rattaché au laboratoire
...
\startblockquote
\useURL[url5][mailto:kevin.caye@gmail.com][][kevin.caye@gmail.com]\from[url5]
• +33 6 19 45 11 46 • 28 ans\crlf
1 rue du tenaison - Saint-Egrève 38120, France\crlf
\useURL[url6][https://cayek.github.io/]\from[url6]
\stopblockquote
